...
const teext = "تم النيك" //هنا تحط وش تبي يكون اسم الرومات الكتابيه
const vooice = "تم النيك" //هنا تحط وش تبي يكون اسم الرومات الصوتيه
...
const spam = "a7med" //هنا تحط وش تبي رسالة السبام
const namee = "a7med" //هنا تحط وش تبي اسم السيرفر واسم البوت والبلاينق
const playing = "تم النيك" //هنا تحط وش تبي يكون الستريمنق
client.on('message', message => {
